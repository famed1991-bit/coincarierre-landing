...
export function Process() {
  ...
  const steps = [
    { id: 1, icon: "/icons/publiez-new.png", title: t('process.step1.title'), desc: t('process.step1.desc') },
    { id: 2, icon: "/icons/recevez-new.png", title: t('process.step2.title'), desc: t('process.step2.desc') },
    { id: 3, icon: "/icons/evaluez-new.png", title: t('process.step3.title'), desc: t('process.step3.desc') },
    { id: 4, icon: "/icons/embauchez-new.png", title: t('process.step4.title'), desc: t('process.step4.desc') },
  ];
